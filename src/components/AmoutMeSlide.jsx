...
const AmoutMeSlide = () => {
  return (
    <div className="bg-neutral-950 pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
      <div className="bg-gradient-to-r from-blue-700 to-blue-950 pb-20 sm:pb-24 xl:pb-0 ">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
          <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
            <div className="relative aspect-[4/4] h-full w-full md:-mx-8 xl:mx-0 xl:aspect-auto ">
              <img
